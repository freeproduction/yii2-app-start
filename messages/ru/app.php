...
return [
    ...
    'This is the About page. You may modify the following file to customize its content:' => 'Эта страница о Вашем проекте. Вы можете изменить эти данные в следующем файле:',
    ...
    'If you have business inquiries or other questions, please fill out the following form to contact us. Thank you.' => 'Если у вас есть вопросы или предложения, пожалуйста заполните следующую форму, чтобы связаться с нами.',
    'Submit' => 'Подтвердить',
    ...
    'You may login with <strong>{admin/admin}</strong> or {<strong>demo/demo</strong>.<br>} To modify the username/password, please check out the code {<code>app\models\User::$users</code>}.' => 'Вы можете войти под пользователем <strong>admin/admin</strong> или <strong>demo/demo</strong>.<br> Измененить имя пользователя и пароль можно в файле <code>app\models\User::$users</code>.',
